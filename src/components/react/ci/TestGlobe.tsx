...
import earthTopology from '../../../assets/ci/earth-topology.png?url';
import nightSky from '../../../assets/ci/night-sky.png?url';
import earthDay from '../../../assets/ci/earth-day.jpg?url';
