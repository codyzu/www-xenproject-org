...
<Section class="section-square-primary content-markdown">
  ...
  <p>These Windows PV Drivers have not been refreshed in a long time. Refer to the <a href="https://xenbits.xen.org/gitweb/?a=project_list;pf=pvdrivers/win"><strong>Windows PV repositories on Xenbits</strong> <i class="fas fa-arrow-up-right-from-square"></i></a> for the available source repositories and current project state.</p>
</Section>
