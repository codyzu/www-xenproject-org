...
<Fragment slot="media">
  <div className="w-100">
    <div className="txt-l"><img src="/img/logos/arm-logo.svg" alt="ARM logo" width="250" /></div>
    <div className="txt-r mg-t-lg"><img src="/img/logos/amd-logo.svg" alt="AMD logo" width="250" /></div>
  </div>
</Fragment>
