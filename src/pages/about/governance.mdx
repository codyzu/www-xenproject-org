...
title: Governance
description: Learn how the Xen Project governs open technical decisions, project roles, the Advisory Board, and Safety Committee coordination.
keywords:
  - Xen Project
...
<div id="safety-governance">

  <h3>Xen Safety Committee</h3>

  <p>The Xen Safety Committee is a formal project committee that coordinates certification-oriented processes and committee-managed safety artifacts. Premier Plus members appoint voting representatives to both the Xen Project Advisory Board and the Safety Committee, participate directly in committee work, and help set priorities and roadmap. Upstream technical decisions continue through Xen's established open contribution, maintainer review, and project governance processes. The committee does not replace maintainer review, and membership does not confer technical authority.</p>

  <p><a href="/technology/safety/">Explore safety engineering</a> or <a href="/about/become-a-member/">explore Premier Plus membership</a>.</p>
