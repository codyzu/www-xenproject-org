...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'xen-popover-link':
      'xen-focus uno-relative uno-flex uno-overflow-hidden uno-rounded-xp-md uno-border uno-border-solid uno-border-transparent uno-px-3 uno-py-2 uno-text-sm uno-font-semibold uno-text-xp-text-primary uno-no-underline uno-transition-[background-color,border-color] uno-duration-[var(--xp-motion-fast)] uno-ease-[var(--xp-ease-standard)] before:uno-pointer-events-none before:uno-absolute before:uno-inset-y-2 before:uno-left-1.5 before:uno-w-0.5 before:uno-rounded-full before:uno-bg-xp-accent-primary before:uno-opacity-0 before:uno-content-empty before:uno-transition-opacity before:uno-duration-[var(--xp-motion-fast)] hover:uno-border-xp-border-muted hover:uno-bg-xp-surface-2 hover:uno-text-xp-text-primary hover:before:uno-opacity-100 focus-visible:uno-border-xp-border-muted focus-visible:uno-bg-xp-surface-2 focus-visible:uno-text-xp-text-primary focus-visible:before:uno-opacity-100 active:uno-bg-xp-surface-3 active:uno-text-xp-text-primary',
